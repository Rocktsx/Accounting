...
{
    public static void AddAccountingHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("Accounting Health Status", configuration["App:HealthUiCheckUrl"] ?? healthCheckUrl);
        });
