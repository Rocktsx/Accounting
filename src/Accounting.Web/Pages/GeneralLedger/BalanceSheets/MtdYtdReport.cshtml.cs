...
namespace Accounting.Web.Pages.GeneralLedger.BalanceSheets
{
    [Authorize(Permissions.AccountingPermissions.BalanceSheetReports.MonthToDateYearToDateReport)]
    public class MtdYtdReportModel : PageModel
    {
        ...
        public MtdYtdReportModel(IAccountingPeriodAppService accountingPeriodAppService)
        {
