...
{
    [Authorize(Permissions.AccountingPermissions.ProfitAndLossReports.TwelveMonthsReport)]
    public class TwelveMonthsReportModel : PageModel
    {
        ...
        public TwelveMonthsReportModel(IAccountingPeriodAppService accountingPeriodAppService)
        {
