...
{
    [Authorize(Permissions.AccountingPermissions.JournalReports.SingleCurrencySortByDateReport)]
    public class SingleCurrencySortByDateReport : AccountingPageModel
    {
