$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/AccountingPeriods/EditModal');
    const isGrantedEdit = abp.auth.isGranted('Accounting.GeneralLedger.AccountingPeriod.Edit');
    const isGrantedDelete = abp.auth.isGranted('Accounting.GeneralLedger.AccountingPeriod.Deletion');
    ...
    const createModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/AccountingPeriods/CreateModal');
