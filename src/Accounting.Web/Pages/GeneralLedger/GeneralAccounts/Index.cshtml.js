$(function () {
    ...
    const createModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/GeneralAccounts/CreateModal');
    ...
    const importModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/GeneralAccounts/ImportModal');
