$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/AccountingPeriod/EditModal');
    ...
    const createModal = new abp.ModalManager(abp.appPath + 'GeneralLedger/AccountingPeriod/CreateModal');
