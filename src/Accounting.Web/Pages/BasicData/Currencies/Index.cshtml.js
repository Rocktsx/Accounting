$(function () {
    ...
    var editModal = new abp.ModalManager(abp.appPath + 'BasicData/Currencies/EditModal');
    ...
    var createModal = new abp.ModalManager(abp.appPath + 'BasicData/Currencies/CreateModal');
