    ...
    const store = new Vuex.Store({
        ...
        mutations: {
            ...
            setEditItem(state, payload) {
                ...
                state.editItem = { ...others, details: newDetails, debitorId };
    ...
    const PayableDetail = {
        ...
        methods: {
            ...
            generateDetails() {
                ...
                const debitorId = this.editItem.debitorId;
                if (!debitorId) {
...
<Modal v-if="isShow" :value="isShow" @input="input" @save="save" :title="l('Detail')" modal-id="edit-modal">
    ...
    const EditHeader = {
        ...
        props: ['errors'],
        computed: {
            ...Vuex.mapGetters(['editItem', 'vendors']),
        },
        mounted() {
            const _this = this;
            this.$nextTick(() => {
                initCompanySelect(false, '#debitorId', '#debitor',
                    e => {
                        _this.editItem.debitorId = e.params.data.id;
