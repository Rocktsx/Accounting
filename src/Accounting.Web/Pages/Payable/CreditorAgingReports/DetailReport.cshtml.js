$(function () {
    ...
    function setTotal(item, total, params) { 
    ...
    function handleData(items, params) {
        ...
        items.reduce((prev, current) => {
            ...
            setTotal(current, group, params);
            setTotal(current, total, params);
    ...
    const store = new Vuex.Store({
        ...
        mutations: {
            setItems(state, payload) {
                const { items } = payload;
                const { groups, total } = handleData(items, state.params);
                state.items = groups;
                state.total = total;
            },
    ...
    $(document).on('click', '#searchBtn', function () {
        ...
        accounting.finance.reports.payableAgingReport.getAgingDetailList(params).then(function (result) {
