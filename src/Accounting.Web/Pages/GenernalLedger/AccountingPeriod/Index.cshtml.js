$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/AccountingPeriod/EditModal');
    const isGrantedEdit = abp.auth.isGranted('Accounting.GenernalLedger.AccountingPeriod.Edit');
    const isGrantedDelete = abp.auth.isGranted('Accounting.GenernalLedger.AccountingPeriod.Deletion');
    ...
    const createModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/AccountingPeriod/CreateModal');
