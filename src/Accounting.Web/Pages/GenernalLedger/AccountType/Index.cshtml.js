$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/AccountType/EditModal'); 
    const isGrantedEdit = abp.auth.isGranted('Accounting.GenernalLedger.AccountType.Edit');
    const isGrantedDelete = abp.auth.isGranted('Accounting.GenernalLedger.AccountType.Deletion');
    let accountTypes = [];
    ...
    const createModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/AccountType/CreateModal');
