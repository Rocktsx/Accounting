$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/ChartOfAccount/EditModal');
    const isGrantedEdit = abp.auth.isGranted('Accounting.GenernalLedger.Subject.Edit');
    const isGrantedDelete = abp.auth.isGranted('Accounting.GenernalLedger.Subject.Deletion');
...
const createModal = new abp.ModalManager(abp.appPath + 'GenernalLedger/ChartOfAccount/CreateModal');
