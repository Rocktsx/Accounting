$(function () {
    ...
    const editModal = new abp.ModalManager(abp.appPath + 'GenenalLedger/ChartOfAccount/EditModal');
    const isGrantedEdit = abp.auth.isGranted('Accounting.GenenalLedger.Subject.Edit');
    const isGrantedDelete = abp.auth.isGranted('Accounting.GenenalLedger.Subject.Deletion');
...
const dataTable = $('#subjectTable').DataTable(
    abp.libs.datatables.normalizeConfiguration({
        ...
        columnDefs: [
            ...
            {
                title: l('IsSubSujectType'),
                data: "isSubSujectType",
                orderable: false,
                render: boolRender
            },
            {
...
const createModal = new abp.ModalManager(abp.appPath + 'GenenalLedger/ChartOfAccount/CreateModal');
