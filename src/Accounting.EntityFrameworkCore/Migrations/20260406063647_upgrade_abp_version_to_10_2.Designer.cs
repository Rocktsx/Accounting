...
namespace Accounting.Migrations
{
    ...
    [Migration("20260406063647_upgrade_abp_version_to_10_2")]
    partial class upgrade_abp_version_to_10_2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.BasicData.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Accounting.BasicData.Companies.CompanyAddress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCompanyAddresses", (string)null);
                });

            modelBuilder.Entity("Accounting.BasicData.Companies.CompanyContact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppCompanyContacts", (string)null);
                });

            modelBuilder.Entity("Accounting.BasicData.Currencies.Currency", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SourceCurrency", "TargetCurrency")
                        .IsUnique()
            ...
            modelBuilder.Entity("Accounting.Finance.AccountTypes.AccountType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasMaxLength(30)
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("BalanceSheetGroup")
                        .HasColumnType("int");

                    b.Property<int>("BalanceSheetSort")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProfitAndLossGroup")
                        .HasColumnType("int");

                    b.Property<int>("ProfitAndLossSort")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TrialBalanceGroup")
                        .HasColumnType("int");

                    b.Property<int>("TrialBalanceSort")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Accounting.Finance.AccountingPeriods.AccountingPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateOnly>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateOnly(2025, 12, 31));
                    ...
                    b.ToTable("AppAccountingPeriods", (string)null);
                });

            modelBuilder.Entity("Accounting.Finance.BankReconciliations.BankReconciliation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBankReconciliations", (string)null);
                });

            modelBuilder.Entity("Accounting.Finance.SubjectCategories.SubjectCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("DebitorCreditor")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppSubjectCategories", (string)null);
                });

            modelBuilder.Entity("Accounting.Finance.Subjects.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsPayMethod")
                        .HasColumnType("bit");

                    b.Property<bool>("IsSubSubjectType")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Accounting.Finance.Vouchers.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Accounting.Finance.Vouchers.VoucherDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("SubSubjectCode")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SubSubjectCode");

                    b.HasIndex("SubjectId");

                    b.HasIndex("VoucherId");

                    b.ToTable("AppVoucherDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Accounting.BasicData.Companies.CompanyAddress", b =>
                {
                    b.HasOne("Accounting.BasicData.Companies.Company", null)
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Accounting.Finance.BankReconciliations.BankReconciliation", b =>
                {
                    b.HasOne("Accounting.Finance.Vouchers.VoucherDetail", "VoucherDetail")
                        .WithOne("BankReconciliation")
                        .HasForeignKey("Accounting.Finance.BankReconciliations.BankReconciliation", "VoucherDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Accounting.Finance.SubjectCategories.SubjectCategory", b =>
                {
                    b.HasOne("Accounting.Finance.AccountTypes.AccountType", "AccountType")
                        .WithMany()
            ...
            modelBuilder.Entity("Accounting.Finance.Subjects.Subject", b =>
                {
                    ...
                    b.HasOne("Accounting.Finance.SubjectCategories.SubjectCategory", "SubjectCategory")
                        .WithMany("Subjects")
            ...
            modelBuilder.Entity("Accounting.Finance.Vouchers.VoucherDetail", b =>
                {
                    b.HasOne("Accounting.BasicData.Companies.Company", "Company")
                        .WithMany()
                        .HasForeignKey("SubSubjectCode")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Accounting.Finance.Subjects.Subject", "Subject")
                        .WithMany()
                        .HasForeignKey("SubjectId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Accounting.Finance.Vouchers.Voucher", "Voucher")
                        .WithMany("Details")
